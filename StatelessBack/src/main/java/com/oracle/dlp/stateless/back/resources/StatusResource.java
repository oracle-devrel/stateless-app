...
import com.oracle.dlp.stateless.back.restdata.StatusResponse;
...
public class StatusResource {
	...
	@Inject
	private PrefixProvider greetingProvider;
	@Inject
	...
	public StatusResponse getStatus() {
		return new StatusResponse(new GreetingPrefix(greetingProvider.getPrefix()), secretValue,
				autoCrash.getAutoTimerInfo(), autoHang.getHangTime(), autoNotReady.getAutoTimerInfo(), VERSION,
				format.format(new Date()), Boolean.TRUE);
	}
}