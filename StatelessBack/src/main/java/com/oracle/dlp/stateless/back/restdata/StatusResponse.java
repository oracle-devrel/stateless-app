...
@NoArgsConstructor
@AllArgsConstructor
@Schema(name = "StatusResponse", description = "Status of the back end system")

public class StatusResponse {
	@Schema(required = true, description = "The prefix", example = "Hello", type = SchemaType.OBJECT)
	private GreetingPrefix prefix;
