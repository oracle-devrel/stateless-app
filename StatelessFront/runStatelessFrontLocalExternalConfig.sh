...
echo Backend IP $BACKIP
docker run  --add-host zipkin:$ZIPKINIP --add-host statelessback:$BACKIP --publish 8080:8080 --rm  --volume $CONF:/$CONTAINER_DIR/conf --name statelessfront com.oracle.dlp.stateless.front
